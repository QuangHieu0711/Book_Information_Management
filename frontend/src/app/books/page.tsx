...
function BookListContent() {
  ...
  const handleEdit = (book: Book) => {
    // Map lại về BookFormData (dùng id của author/category/publisher nếu cần)
    setEditBook({
      id: book.id,
      title: book.title,
      authorId: '', // Nếu muốn sửa cần truyền id, bạn phải map lại đúng authorId, categoryId, publisherId
      categoryId: '',
      publisherId: '',
